...
import tech.alexib.yaba.stubs.json.institutionChaseJson
import tech.alexib.yaba.stubs.json.institutionWellsFargoJson
import tech.alexib.yaba.util.jSerializer

object InstitutionStubs {

    val wellsFargo: Institution by lazy {
        jSerializer.decodeFromString(institutionWellsFargoJson)
    }
    val chase: Institution by lazy {
